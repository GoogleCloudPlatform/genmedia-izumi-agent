...
def deploy_agent_engine_app(
    ...
    if extra_packages is None:
        extra_packages = ["./agents/creative_toolbox_agent"]
    if env_vars is None:
        env_vars = {}

    staging_bucket_uri = f"gs://{project}-agent-engine"
    artifacts_bucket_name = f"{project}-agents-logs-data"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--extra-packages",
        nargs="+",
        default=["./agents/creative_toolbox_agent"],
