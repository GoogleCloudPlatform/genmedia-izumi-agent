...
def test_generate_speech_multiple_speaker_success(mock_asset_service, mock_config):
    ...
    with patch(
        "mediagent_kit.services.media_generation_service.texttospeech_v1beta1.TextToSpeechClient"
...
@patch(
    "mediagent_kit.services.media_generation_service.time.sleep"
)  # Prevent sleeping in tests
